...
const Footer = () => {
    return (
        <footer className='mt-56 w-full bg-gray-200'>
            <div className='mx-auto max-w-screen-2xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24'>
                <div className='grid grid-cols-1 gap-8 lg:grid-cols-3'>
                    <div>
                        <div className='flex max-w-md justify-center text-teal-600 sm:justify-start'>
                    ...
                    <div className='grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2'>
                        <div className='text-center sm:text-left'>
                            <p className='text-lg font-medium text-gray-900'>Locations</p>
                            ...
                            <ul className='mt-8 space-y-4 text-sm'>
                                <li>
                                    <a className='flex items-center  gap-1.5 ltr:sm:justify-start rtl:sm:justify-end' href={`mailto:${process.env.NEXT_PUBLIC_EMAIL}`}>
                                        ...
                                        <span className='flex-1 text-gray-700'>{process.env.NEXT_PUBLIC_EMAIL}</span>
                                    </a>
                                </li>
                                ...
                                <li>
                                    <a className='flex items-center justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end' href={`tel:${process.env.NEXT_PUBLIC_PHONE_NUMBER}`}>
                                        ...
                                        <span className='flex-1 text-gray-700'>{process.env.NEXT_PUBLIC_PHONE_NUMBER}</span>
                                    </a>
                                </li>
                ...
                <div className='mt-12 border-t border-gray-100 pt-6'>
                    <div className='text-center sm:flex sm:justify-between sm:text-left'>
                        <p className='text-sm text-gray-500'>
                            <span className='block sm:inline'>Website Designed & Developed by </span>

                            <a className='inline-block text-primary underline transition hover:text-primary/75' href='https://vikedigital.com.au/'>
