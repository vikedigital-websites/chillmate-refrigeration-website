...
const SideMenu = ({ close, logo, navItems }: Props) => {
    ...
    return (
        <div className='fixed inset-0 z-50'>
            ...
            <nav className={`${slideAnimation} absolute bottom-0 right-0 top-0 flex max-w-[60%] flex-col gap-4 bg-white py-4 pl-8 pr-4 drop-shadow-md [&>a]:flex [&>a]:border-b-2 [&>a]:pb-2`} onAnimationEnd={onAnimationEnd}>
